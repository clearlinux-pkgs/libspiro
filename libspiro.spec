...
Source0  : https://github.com/fontforge/libspiro/archive/20221101/libspiro-20221101.tar.gz
...
%prep
%setup -q -n libspiro-20221101
cd %{_builddir}/libspiro-20221101
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672183220
