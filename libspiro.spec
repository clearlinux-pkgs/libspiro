...
Source0  : https://github.com/fontforge/libspiro/archive/20220722/libspiro-20220722.tar.gz
...
%prep
%setup -q -n libspiro-20220722
cd %{_builddir}/libspiro-20220722
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1664819174
...
cp %{_builddir}/libspiro-%{version}/COPYING %{buildroot}/usr/share/package-licenses/libspiro/8624bcdae55baeef00cd11d5dfcfa60f68710a02
%make_install
